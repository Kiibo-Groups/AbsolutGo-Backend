              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-4 pb-2">
                        ...
                        <p class="text-center small">Ingresa los acceso que se te brindaron al registrarte.</p>
                    </div>
                    ...
                    <form class="row g-3 needs-validation" novalidate action="{{ $form_url }}" method="post">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                                <input class="form-control" type="email" name="username" id="yourUsername" placeholder="Correo electrónico" required="required">
