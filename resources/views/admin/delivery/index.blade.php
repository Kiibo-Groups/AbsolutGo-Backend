...
<div class="col-md-12">
    <div class="row">
        <div class="card py-3 m-b-30">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: right;"><a href="{{ Asset($link.'add') }}" class="btn m-b-15 ml-2 mr-2 btn-rounded btn-warning">Agregar Elemento</a>&nbsp;&nbsp;&nbsp;</div>
            </div>
                ...
                <table class="table table-hover ">
                    ...
                    <td width="5%">
                        @if($row->status == 0)
                            ...
                            <a href="#" class="btn m-b-15 ml-2 mr-2 btn-md  btn-rounded-circle btn-success" onclick="confirmAlert('{{ Asset($link.'status/'.$row->id) }}')" data-toggle="tooltip" data-placement="top" data-original-title="Activar">
                                Activo
                            </a>
                        @else
                            ...
                            <a href="#" class="btn m-b-15 ml-2 mr-2 btn-md  btn-rounded-circle btn-danger" onclick="confirmAlert('{{ Asset($link.'status/'.$row->id) }}')" data-toggle="tooltip" data-placement="top" data-original-title="Desactivar">
                                Inactivo
                            </a>
                        @endif
                    </td>
                    <td width="5%">
                        @if($row->status_admin == 0)
                            <!-- <button type="button" class="btn btn-sm m-b-15 ml-2 mr-2 btn-success" onclick="confirmAlert('{{ Asset($link.'status/'.$row->id) }}')">Active</button> -->
                            <a href="#" class="btn m-b-15 ml-2 mr-2 btn-md  btn-rounded-circle btn-success" onclick="confirmAlert('{{ Asset($link.'status_admin/'.$row->id) }}')" data-toggle="tooltip" data-placement="top" data-original-title="Activar">
                                Activo
                            </a>
                        @else
                            <!-- <button type="button" class="btn btn-sm m-b-15 ml-2 mr-2 btn-danger" onclick="confirmAlert('{{ Asset($link.'status/'.$row->id) }}')">Disabled</button> -->
                            <a href="#" class="btn m-b-15 ml-2 mr-2 btn-md  btn-rounded-circle btn-danger" onclick="confirmAlert('{{ Asset($link.'status_admin/'.$row->id) }}')" data-toggle="tooltip" data-placement="top" data-original-title="Activar">
                                Inactivo
                            </a>
                        @endif
                    </td>
