...
(function() {
   ...
   */
  if (select('.quill-editor-about')) {
    new Quill(".quill-editor-about", {
      modules: {
        toolbar: [
          [{
            font: []
  ...
  if (select('.quill-editor-how')) {
    new Quill(".quill-editor-how", {
      modules: {
        toolbar: [
          [{
            font: []
  ...
  if (select('.quill-editor-faq')) {
    new Quill(".quill-editor-faq", {
      modules: {
        toolbar: [
          [{
            font: []
  ...
  if (select('.quill-editor-contact_us')) {
    new Quill(".quill-editor-contact_us", {
      modules: {
        toolbar: [
          [{
            font: []
